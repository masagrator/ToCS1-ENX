...
namespace ro {
    ...
    /* Module in this game is build in different way than in Smash Bros.
    pathToNro is the only variable that I was interested in and it's correct. 
    All other variables may be incorrect. */
