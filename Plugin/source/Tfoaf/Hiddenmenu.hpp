...
void RenderHiddenMenu(void* x0) {
    ...
    set_UIText_original(x0, 80, base_Y+(32*0), "Audio:", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
    if (Settings.Audio == 0) {
        set_UIText_original(x0, 260, base_Y+(32*0), "[JAP]", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
        if (!EngCheck)
            set_UIText_original(x0, 460, base_Y+(32*0), "ENG", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
    }
    else {
        set_UIText_original(x0, 260, base_Y+(32*0), "JAP", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
        if (!EngCheck)
    ...
    set_UIText_original(x0, 80, base_Y+(32*1), "FPS:", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
    if (Settings.FPS == 30) {
        set_UIText_original(x0, 260, base_Y+(32*1), "[30]", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
        set_UIText_original(x0, 460, base_Y+(32*1), "60", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
    }
    else {
        set_UIText_original(x0, 260, base_Y+(32*1), "30", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
        set_UIText_original(x0, 460, base_Y+(32*1), "[60]", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
    }
    set_UIText_original(x0, 80, base_Y+(32*2), "Rendering Resolution:", 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
    char* RenderRes = 0;
    switch(Settings.RenderingRes) {
        case 0:
    ...
    set_UIText_original(x0, 460, base_Y+(32*2), RenderRes, 0xFFFFFFFF, 0x00000000, 0x00000000, 0, 0, 1.0, 32.0, 1.0);
    if (indicator == 2)
